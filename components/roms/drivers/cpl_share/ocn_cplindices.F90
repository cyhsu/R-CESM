module ocn_cplindices
  ...
  !integer :: index_x2o_Forr_rofl       ! river runoff flux                (kg/m2/s)
  !integer :: index_x2o_Forr_rofi       ! ice runoff flux                  (kg/m2/s)

contains

  subroutine ocn_cplindicesSet( )
    ...
    !index_x2o_Forr_rofl     = mct_avect_indexra(x2o,'Forr_rofl')
    !index_x2o_Forr_rofi     = mct_avect_indexra(x2o,'Forr_rofi')
